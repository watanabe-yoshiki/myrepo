...
$to = "slogan-recruitment-2025@chemiguide.mhlw.go.jp";
...
$from = "slogan-recruitment-2025@chemiguide.mhlw.go.jp";
...
$Referer_check_domain = "chemiguide.mhlw.go.jp";
...
$require = array('スローガン','氏名','住所','電話番号','学校又は勤務先名称');
...
$refrom_name = "令和7年度化学物質管理に係る普及・啓発事業事務局";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【応募受付】第２回化学物質管理強調月間スローガン募集";
...
この度は「第２回化学物質管理強調月間スローガン募集」へのご応募、ありがとうございます。
厚生労働省において選考し、応募されたスローガンの中から、金賞、銀賞、銅賞を決定します。
結果は　採用者に通知するほか、厚生労働省報道発表ページ等で発表します。
