...
$site_top = "https://chemiguide.mhlw.go.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "s-tanaka@one-inc.co.jp,nakayama@one-inc.co.jp";
...
$from = "risk-communication@one-inc.co.jp";
...
$require = array('セミナー参加形式','ワークショップ参加形式','お名前（漢字）','お名前（フリガナ）','電話番号','Email','所属企業','所属部署','役職','職種','年齢','問1','問2','問3','問4','問5','問6','問9','問10','問11','問12');
...
$refrom_name = "令和6年度化学物質管理に係る普及・啓発事業事務局";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【申込受付】安全な職場を実現するための化学物質管理セミナー";
...
この度は「安全な職場を実現するための化学物質管理セミナー」への参加お申し込み、ありがとうございます。
後日、お申し込みされた方全員に、参加の可否、参加に当たっての詳細のメールをお送りします。

※受付は先着順となります。定員に達した場合には、申込期限より前に受付を終了する場合がありますので、ご了承下さい。
※第2部の様子もwebで配信する予定ですが、各グループのディスカッションを選んで視聴することは出来ません。
※資料は開催日の前日までに厚生労働省のウェブサイトに掲載される予定です。会場での配布は行いませんので、ご了承ください。
...
＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
令和6年度化学物質管理に係る普及・啓発事業事務局
株式会社one
E-mail ::risk-communication@one-inc.co.jp
TEL: 080-9044-5226（受付時間［平日］10時〜17時） 担当︓田中、中山
                ...
                <div class="header-inner">
                    <div class="header-inner__logo">
                        <a href="https://www.mhlw.go.jp/index.html" target="_blank">
							<img src="./images/logo_mhlw.png" width="170px" alt="厚生労働省">
						</a>
						<a href="https://chemiguide.mhlw.go.jp/" target="_blank">
                            <img src="./images/logo.png" width="180px" alt="ケミガイド">
                        </a>
                    </div>
                    <div class="header-inner__nav">
                        <ul>
                            <li><a href="../">ケミガイド</a></li>
                            <li><span>安全な職場を実現するための化学物質管理セミナー</span></li>
                        </ul>
                    </div>
                </div>
            </div><!-- /header_inner -->
...
<?php echo $errm; ?><br /><br />
	<div class="about__button"><input type="button" class="button button03" value=" 前画面に戻る " onClick="history.back()"></div>
</div>
<?php }else{ ?>
<section id="apply" class="contact contents-section">
                <h2 style="font-size: 2.6rem; margin-top: 20px;">送信内容のご確認</h2>
	<div class="wrap">
...
<input type="submit" class="button button01" value="送信">
<input type="button" class="button button03" value="前画面に戻る" onClick="history.back()"></div>
</p>
</form>
</div>
</section>
...
<!-- ▼ Footerその他コンテンツなど　※編集可 ▼-->
        <footer>
            <div class="wrap">
                <span>〒100−8916 東京都千代田区霞が関１丁目２番２号<br>
					中央合同庁舎 第５号館<br>
					厚生労働省労働基準局安全衛生部化学物質対策課<br>
					<br>
					Copyright © Ministry of Health, Labour and Welfare of Japan</span>
            </div>
        </footer><!-- /footer -->
	</div>
</body>
